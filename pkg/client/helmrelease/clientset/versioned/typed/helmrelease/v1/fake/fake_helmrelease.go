...
func (c *FakeHelmReleases) Get(name string, options v1.GetOptions) (result *helmreleasev1.HelmRelease, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(helmreleasesResource, c.ns, name), &helmreleasev1.HelmRelease{})

	if obj == nil {
		return nil, err
	}
	return obj.(*helmreleasev1.HelmRelease), err
}

// List takes label and field selectors, and returns the list of HelmReleases that match those selectors.
func (c *FakeHelmReleases) List(opts v1.ListOptions) (result *helmreleasev1.HelmReleaseList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(helmreleasesResource, helmreleasesKind, c.ns, opts), &helmreleasev1.HelmReleaseList{})
	...
	list := &helmreleasev1.HelmReleaseList{ListMeta: obj.(*helmreleasev1.HelmReleaseList).ListMeta}
	for _, item := range obj.(*helmreleasev1.HelmReleaseList).Items {
...
func (c *FakeHelmReleases) Create(helmRelease *helmreleasev1.HelmRelease) (result *helmreleasev1.HelmRelease, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(helmreleasesResource, c.ns, helmRelease), &helmreleasev1.HelmRelease{})
...
func (c *FakeHelmReleases) Update(helmRelease *helmreleasev1.HelmRelease) (result *helmreleasev1.HelmRelease, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(helmreleasesResource, c.ns, helmRelease), &helmreleasev1.HelmRelease{})
...
func (c *FakeHelmReleases) UpdateStatus(helmRelease *helmreleasev1.HelmRelease) (*helmreleasev1.HelmRelease, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(helmreleasesResource, "status", c.ns, helmRelease), &helmreleasev1.HelmRelease{})
...
func (c *FakeHelmReleases) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(helmreleasesResource, c.ns, name), &helmreleasev1.HelmRelease{})
...
func (c *FakeHelmReleases) DeleteCollection(options *v1.DeleteOptions, listOptions v1.ListOptions) error {
	...
	_, err := c.Fake.Invokes(action, &helmreleasev1.HelmReleaseList{})
	return err
}

// Patch applies the patch and returns the patched helmRelease.
func (c *FakeHelmReleases) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *helmreleasev1.HelmRelease, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(helmreleasesResource, c.ns, name, pt, data, subresources...), &helmreleasev1.HelmRelease{})
